...
In this post, I'll explain why this argument is silly and reductive, why folks who are new to building computer systems shouldn't pay attention to it, and why people who trot it out are best ignored.
...
* Durability. Making multiple copies of data on multiple machines is the only credible way to make online data highly durable. Single-system approaches like RAID are based on a fundamentally flawed assumption about failure independence. Offline data can be made durable will offline backups, of course.

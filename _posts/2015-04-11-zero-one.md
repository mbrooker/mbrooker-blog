...
I have a candidate: the [zero-one-infinity rule](http://en.wikipedia.org/wiki/Zero_one_infinity_rule). In spirit, zero-one-infinity is valuable. It councils against arbitrary limits, and points out that arbitrary limits are a strong hint that system or piece of code was poorly considered.
...
Zero-one-infinity is often taken to council against numerical instincts.
...
Zero-one-infinity is often taken as council against numbers.
